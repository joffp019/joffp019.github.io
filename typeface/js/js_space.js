...
var night = ["images/space/night.jpg", "images/space/nightglitch.jpg"];
var dubai = ["images/space/dubai.jpg", "images/space/dubaiglitch.jpg"];
var hurricane = ["images/space/hurricane.jpg", "images/space/hurricaneglitch.jpg"];
...
$(window).resize(function() {
    $(".hurricane").each(function() {
        var randomhurricane = hurricane[Math.floor(Math.random()*2)];
...
$(window).resize(function() {
    $(".night").each(function() {
        var randomnight = night[Math.floor(Math.random()*2)];
...
$(window).resize(function() {
    $(".dubai").each(function() {
        var randomdubai = dubai[Math.floor(Math.random()*2)];
